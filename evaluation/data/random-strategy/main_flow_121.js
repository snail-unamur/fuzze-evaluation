...
registry.category("web_tour.tours").add('fuzz_main_flow_tour_121', {
    ...
    steps: () => [...stepUtils.goToAppSteps('sale.sale_menu_root', markup(_t('Organize your sales activities with the <b>Sales app</b>.'))), stepUtils.openBurgerMenu(".o_breadcrumb .active:contains('Quotations')"), {
        ...
        mobile: false,
        trigger: ".o_kanban_group:first .o_kanban_record span:contains('Z\?_\^\~\+\?')",
        ...
        mobile: false,
        trigger: ".o_kanban_group:eq(2) > .o_kanban_record span:contains('Z\?_\^\~\+\?')",
        ...
        position: "bottom",
        run: "text -2831403467.3169301473",
    }, {
        mobile: false,
        edition: "enterprise",
