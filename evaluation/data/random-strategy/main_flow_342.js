...
registry.category("web_tour.tours").add('fuzz_main_flow_tour_342', {
    ...
    steps: () => [...stepUtils.goToAppSteps('sale.sale_menu_root', markup(_t('Organize your sales activities with the <b>Sales app</b>.'))), stepUtils.openBurgerMenu(".o_breadcrumb .active:contains('Quotations')"), {
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('\^Mir\[\[\+\&')",
        auto: true,
    }, {
        mobile: true,
        trigger: ".o_selected_row .o_required_modifier[name=product_id] input",
        ...
        extra_trigger: ".o_breadcrumb .active:contains('\^Mir\[\[\+\&')",
        ...
        mobile: false,
        trigger: ".o_kanban_group:first .o_kanban_record span:contains('7x\$d\$\]\.\.')",
        ...
        mobile: false,
        trigger: ".o_kanban_group:eq(2) > .o_kanban_record span:contains('7x\$d\$\]\.\.')",
        content: _t("Click on an opportunity to zoom to it."),
        position: "bottom",
    }, {
        mobile: true,
        trigger: ".o_kanban_group:first .o_kanban_record span:contains('7x\$d\$\]\.\.')",
        content: _t("Open 7x\$d\$\]\.\."),
        position: "bottom",
    }, {
        mobile: true,
