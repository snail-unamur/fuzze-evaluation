...
registry.category("web_tour.tours").add('fuzz_main_flow_tour_589', {
    ...
    steps: () => [...stepUtils.goToAppSteps('sale.sale_menu_root', markup(_t('Organize your sales activities with the <b>Sales app</b>.'))), stepUtils.openBurgerMenu(".o_breadcrumb .active:contains('Quotations')"), {
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('X/IBxP\*\-\^\-')",
        in_modal: false,
    }, {
        mobile: true,
        ...
        mobile: false,
        trigger: ".o_field_x2many_list_row_add > a",
        extra_trigger: ".o_breadcrumb .active:contains('V8\.\.\-\+')",
        content: _t("Click here to add some lines."),
        position: "bottom",
    }, {
        mobile: true,
        ...
        content: _t("Select a vendor, or create a new one on the fly."),
        position: "bottom",
    }, ...stepUtils.mobileKanbanSearchMany2X('Vendor', 'X/IBxP\*\-\^\-'), {
        mobile: false,
        trigger: ".o_field_widget[name=seller_ids] .o_field_x2many_list_row_add > a",
        content: _t("Let's enter the cost price"),
        position: 'right',
        ...
        mobile: false,
        trigger: ".o_kanban_group:first .o_kanban_record span:contains('4L\+Vg/\&\.\|\]')",
        ...
        mobile: false,
        trigger: ".o_kanban_group:eq(2) > .o_kanban_record span:contains('4L\+Vg/\&\.\|\]')",
        content: _t("Click on an opportunity to zoom to it."),
        position: "bottom",
    }, {
        mobile: true,
        trigger: ".o_kanban_group:first .o_kanban_record span:contains('4L\+Vg/\&\.\|\]')",
        content: _t("Open 4L\+Vg/\&\.\|\]"),
        position: "bottom",
    }, {
        mobile: true,
        ...
        mobile: false,
        trigger: "td[name='name'][data-tooltip*='V8\.\.\-\+']",
        run: () => {},
    }, {
        mobile: true,
        ...
        content: _t("Select a product, or create a new one on the fly. The product will define the default sales price (that you can change), taxes and description automatically."),
        position: "right",
    }, ...stepUtils.mobileKanbanSearchMany2X('Product', 'V8\.\.\-\+'), {
        mobile: false,
        trigger: ".o_field_widget[name=order_line] .o_field_x2many_list_row_add > a",
        content: _t("Click here to add some lines to your quotations."),
        position: "bottom",
        ...
        mobile: true,
        trigger: ".o_field_widget[name=product_id] input",
        extra_trigger: ".o_field_widget[name=order_line] .oe_kanban_card:contains('V8\.\.\-\+')",
        content: _t("Select a product, or create a new one on the fly. The product will define the default sales price (that you can change), taxes and description automatically."),
        position: "right",
        ...
        mobile: false,
        trigger: ".o_data_row:has(.o_data_cell:contains('X/IBxP\*\-\^\-')) .o_data_cell:first",
        content: _t('Select the generated request for quotation'),
        position: 'bottom',
    }, {
        mobile: true,
        trigger: ".o_kanban_record .o_kanban_record_title:contains('X/IBxP\*\-\^\-')",
        content: _t('Select the generated request for quotation'),
        position: 'bottom',
        ...
        mobile: false,
        trigger: ".o_data_row:has(.o_data_cell:contains('V8\.\.\-\+')):first .o_data_cell:first",
        content: _t('Select the generated manufacturing order'),
        position: 'bottom',
    }, {
        mobile: true,
        trigger: ".o_kanban_record .o_kanban_record_title:contains('V8\.\.\-\+'):first",
