...
registry.category("web_tour.tours").add('fuzz_main_flow_tour_706', {
    ...
    steps: () => [...stepUtils.goToAppSteps('sale.sale_menu_root', markup(_t('Organize your sales activities with the <b>Sales app</b>.'))), stepUtils.openBurgerMenu(".o_breadcrumb .active:contains('Quotations')"), {
        ...
        mobile: false,
        trigger: ".o_data_cell:contains('hk@\+\|\^\*')",
        ...
        mobile: false,
        edition: "enterprise",
        trigger: "div.o_bank_rec_st_line_kanban_card span:contains('hk@\+\|\^\*')",
        extra_trigger: "div.o_bank_rec_st_line_kanban_card span:contains('hk@\+\|\^\*')",
