...
registry.category("web_tour.tours").add('fuzz_main_flow_tour_751', {
    test: true,
    url: "/web",
    steps: () => [...stepUtils.goToAppSteps('sale.sale_menu_root', markup(_t('Organize your sales activities with the <b>Sales app</b>.'))), stepUtils.openBurgerMenu(".o_breadcrumb .active:contains('Quotations')"), {
        ...
        extra_trigger: ".o_breadcrumb .active:contains('@\#Ja\}\{\~\?')",
        ...
        mobile: false,
        trigger: ".o_field_widget[name=partner_id] input",
        extra_trigger: ".o_breadcrumb .active:contains('5y\-\{\-\{')",
        content: _t('Select a seller'),
        position: 'top',
        run: "text M%\*\?\?\[",
    }, {
        ...
        mobile: false,
        trigger: ".o_kanban_group:first .o_kanban_record span:contains('ow\}2\~\~\?\$\|')",
        ...
        mobile: false,
        trigger: ".o_kanban_group:eq(2) > .o_kanban_record span:contains('ow\}2\~\~\?\$\|')",
        content: _t("Click on an opportunity to zoom to it."),
        position: "bottom",
    }, {
        mobile: true,
        trigger: ".o_kanban_group:first .o_kanban_record span:contains('ow\}2\~\~\?\$\|')",
        content: _t("Open ow\}2\~\~\?\$\|"),
        position: "bottom",
    }, {
        mobile: true,
        ...
        content: _t("Write the name of your product."),
        position: "top",
    }, ...stepUtils.mobileKanbanSearchMany2X('Product', '5y\-\{\-\{'), {
        ...
        mobile: false,
        edition: "enterprise",
        trigger: "div.o_bank_rec_st_line_kanban_card span:contains('GZ\}\&\#\[')",
        extra_trigger: "div.o_bank_rec_st_line_kanban_card span:contains('GZ\}\&\#\[')",
