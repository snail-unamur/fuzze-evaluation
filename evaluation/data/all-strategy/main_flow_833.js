...
registry.category("web_tour.tours").add('fuzz_main_flow_tour_833', {
    test: true,
    url: "/web",
    steps: () => [...stepUtils.goToAppSteps('sale.sale_menu_root', markup(_t('Organize your sales activities with the <b>Sales app</b>.'))), stepUtils.openBurgerMenu(".o_breadcrumb .active:contains('Quotations')"), {
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('u@6=\|\.\&\]')",
        auto: true,
    }, {
        mobile: true,
        trigger: ".o_selected_row .o_required_modifier[name=product_id] input",
        ...
        extra_trigger: ".o_breadcrumb .active:contains('u@6=\|\.\&\]')",
        content: _t('Select a seller'),
        position: 'top',
        run: "text \-L6\]\}\-\-",
    }, {
        mobile: false,
        trigger: ".ui-menu-item > a:contains('\-L6\]\}\-\-')",
        in_modal: false,
    }, {
        mobile: true,
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('o82\$\}\$\+')",
        auto: true,
    }, {
        mobile: false,
        trigger: ".o_selected_row .o_external_button",
        ...
        content: _t("Select a vendor, or create a new one on the fly."),
        position: "bottom",
    }, ...stepUtils.mobileKanbanSearchMany2X('Vendor', '\-L6\]\}\-\-'), {
        mobile: false,
        trigger: ".o_field_widget[name=seller_ids] .o_field_x2many_list_row_add > a",
        content: _t("Let's enter the cost price"),
        position: 'right',
        ...
        mobile: false,
        trigger: ".o_field_widget[name=partner_id] input",
        extra_trigger: ".o_breadcrumb .active:contains('o82\$\}\$\+')",
        content: _t('Select a seller'),
        position: 'top',
        run: "text \-L6\]\}\-\-",
    }, {
        ...
        mobile: false,
        trigger: ".o-autocomplete--dropdown-item > a:contains('N9qX2\|\|\+\~')",
        auto: true,
    }, {
        mobile: true,
        trigger: ".modal-footer .btn-primary:contains('Save')",
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('5Y\}\^\-\{')",
        auto: true,
    }, {
        mobile: true,
        trigger: ".modal-footer .btn-primary:contains('Save')",
        ...
        mobile: false,
        trigger: ".o_kanban_group:first .o_kanban_record span:contains('Z5\#\{\^\^')",
        ...
        mobile: false,
        trigger: ".o_kanban_group:eq(2) > .o_kanban_record span:contains('Z5\#\{\^\^')",
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('S7X\#\[\#\&')",
    }, {
        mobile: false,
        trigger: "td[name='name'][data-tooltip*='S7X\#\[\#\&']",
        run: () => {},
    }, {
        mobile: false,
        ...
        content: _t("Select a product, or create a new one on the fly. The product will define the default sales price (that you can change), taxes and description automatically."),
        position: "right",
    }, ...stepUtils.mobileKanbanSearchMany2X('Product', 'S7X\#\[\#\&'), {
        mobile: true,
        trigger: ".modal-footer .btn-primary:contains('Save & Close')",
        extra_trigger: ".modal:not(.o_inactive_modal) .modal-title:contains('Order Lines')",
        content: _t('Save & Close'),
        ...
        content: _t("Write the name of your product."),
        position: "top",
    }, ...stepUtils.mobileKanbanSearchMany2X('Product', 'o82\$\}\$\+'), {
        ...
        mobile: false,
        trigger: ".o_data_row:has(.o_data_cell:contains('\-L6\]\}\-\-')) .o_data_cell:first",
        content: _t('Select the generated request for quotation'),
        position: 'bottom',
    }, {
        mobile: true,
        trigger: ".o_kanban_record .o_kanban_record_title:contains('\-L6\]\}\-\-')",
        content: _t('Select the generated request for quotation'),
        position: 'bottom',
        ...
        content: "save",
        trigger: ".o_form_button_save",
    }, ...stepUtils.goBackBreadcrumbsMobile(_t('Back to the sale order'), undefined, ".o_breadcrumb .active:contains('S7X\#\[\#\&')"), {
        mobile: false,
        ...
        mobile: false,
        edition: "enterprise",
        trigger: "div.o_bank_rec_st_line_kanban_card span:contains('5Y\}\^\-\{')",
        extra_trigger: "div.o_bank_rec_st_line_kanban_card span:contains('5Y\}\^\-\{')",
