...
registry.category("web_tour.tours").add('fuzz_main_flow_tour_54', {
    test: true,
    url: "/web",
    steps: () => [...stepUtils.goToAppSteps('sale.sale_menu_root', markup(_t('Organize your sales activities with the <b>Sales app</b>.'))), stepUtils.openBurgerMenu(".o_breadcrumb .active:contains('Quotations')"), {
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('Wafa7\?\-\[\{')",
        auto: true,
    }, {
        mobile: true,
        trigger: ".o_selected_row .o_required_modifier[name=product_id] input",
        ...
        extra_trigger: ".o_breadcrumb .active:contains('Wafa7\?\-\[\{')",
        ...
        mobile: false,
        trigger: ".o_field_x2many_list_row_add > a",
        extra_trigger: ".o_breadcrumb .active:contains('UW\|\#\?\]')",
        content: _t("Click here to add some lines."),
        position: "bottom",
    }, {
        mobile: true,
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('O;mR\^\?\.\~\|')",
        auto: true,
    }, {
        mobile: false,
        trigger: ".o_selected_row .o_external_button",
        ...
        mobile: false,
        trigger: ".o_field_widget[name=partner_id] input",
        extra_trigger: ".o_breadcrumb .active:contains('O;mR\^\?\.\~\|')",
        content: _t('Select a seller'),
        position: 'top',
        run: "text \$,\$\]\-\?\+",
    }, {
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('vx\$\-\}\{')",
        auto: true,
    }, {
        mobile: true,
        trigger: ".modal-footer .btn-primary:contains('Save')",
        ...
        mobile: false,
        trigger: ".o_kanban_group:first .o_kanban_record span:contains('LK\{\[\?\|')",
        ...
        mobile: false,
        trigger: ".o_kanban_group:eq(2) > .o_kanban_record span:contains('LK\{\[\?\|')",
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('UW\|\#\?\]')",
    }, {
        mobile: false,
        trigger: "td[name='name'][data-tooltip*='UW\|\#\?\]']",
        run: () => {},
    }, {
        mobile: true,
        ...
        content: _t("Select a product, or create a new one on the fly. The product will define the default sales price (that you can change), taxes and description automatically."),
        position: "right",
    }, ...stepUtils.mobileKanbanSearchMany2X('Product', 'UW\|\#\?\]'), {
        mobile: false,
        trigger: ".o_field_widget[name=order_line] .o_field_x2many_list_row_add > a",
        content: _t("Click here to add some lines to your quotations."),
        position: "bottom",
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains(':5i\.\^\?\{')",
    }, {
        mobile: false,
        trigger: "td[name='name'][data-tooltip*=':5i\.\^\?\{']",
        run: () => {},
    }, {
        mobile: false,
        ...
        mobile: true,
        trigger: ".o_field_widget[name=product_id] input",
        extra_trigger: ".o_field_widget[name=order_line] .oe_kanban_card:contains('UW\|\#\?\]')",
        content: _t("Select a product, or create a new one on the fly. The product will define the default sales price (that you can change), taxes and description automatically."),
        position: "right",
    }, ...stepUtils.mobileKanbanSearchMany2X('Product', ':5i\.\^\?\{'), {
        mobile: true,
        trigger: ".modal-footer .btn-primary:contains('Save & Close')",
        extra_trigger: ".modal:not(.o_inactive_modal) .modal-title:contains('Order Lines')",
        content: _t('Save & Close'),
        ...
        content: _t("Write the name of your product."),
        position: "top",
    }, ...stepUtils.mobileKanbanSearchMany2X('Product', 'O;mR\^\?\.\~\|'), {
        ...
        mobile: false,
        trigger: ".o_data_row:has(.o_data_cell:contains('UW\|\#\?\]')):first .o_data_cell:first",
        content: _t('Select the generated manufacturing order'),
        position: 'bottom',
    }, {
        mobile: true,
        trigger: ".o_kanban_record .o_kanban_record_title:contains('UW\|\#\?\]'):first",
        ...
        content: "save",
        trigger: ".o_form_button_save",
    }, ...stepUtils.goBackBreadcrumbsMobile(_t('Back to the sale order'), undefined, ".o_breadcrumb .active:contains(':5i\.\^\?\{')"), {
        mobile: false,
        ...
        mobile: false,
        edition: "enterprise",
        trigger: "div.o_bank_rec_st_line_kanban_card span:contains('vx\$\-\}\{')",
        extra_trigger: "div.o_bank_rec_st_line_kanban_card span:contains('vx\$\-\}\{')",
