...
registry.category("web_tour.tours").add('fuzz_main_flow_tour_239', {
    test: true,
    url: "/web",
    steps: () => [...stepUtils.goToAppSteps('sale.sale_menu_root', markup(_t('Organize your sales activities with the <b>Sales app</b>.'))), stepUtils.openBurgerMenu(".o_breadcrumb .active:contains('Quotations')"), {
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('iG\-\{\}\-')",
        auto: true,
    }, {
        mobile: true,
        trigger: ".o_selected_row .o_required_modifier[name=product_id] input",
        ...
        extra_trigger: ".o_breadcrumb .active:contains('iG\-\{\}\-')",
        content: _t('Select a seller'),
        position: 'top',
        run: "text 8n\+S\?\|\$\[",
    }, {
        mobile: false,
        trigger: ".ui-menu-item > a:contains('8n\+S\?\|\$\[')",
        in_modal: false,
    }, {
        mobile: true,
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('m_1\{\+\|\?')",
        auto: true,
    }, {
        mobile: false,
        trigger: ".o_selected_row .o_external_button",
        ...
        content: _t("Select a vendor, or create a new one on the fly."),
        position: "bottom",
    }, ...stepUtils.mobileKanbanSearchMany2X('Vendor', '8n\+S\?\|\$\['), {
        mobile: false,
        trigger: ".o_field_widget[name=seller_ids] .o_field_x2many_list_row_add > a",
        content: _t("Let's enter the cost price"),
        position: 'right',
        ...
        mobile: false,
        trigger: ".o_field_widget[name=partner_id] input",
        extra_trigger: ".o_breadcrumb .active:contains('m_1\{\+\|\?')",
        content: _t('Select a seller'),
        position: 'top',
        run: "text 8n\+S\?\|\$\[",
    }, {
        ...
        mobile: false,
        trigger: ".o-autocomplete--dropdown-item > a:contains('24%:\{\$\&\+')",
        auto: true,
    }, {
        mobile: true,
        trigger: ".modal-footer .btn-primary:contains('Save')",
        ...
        content: _t("Write the name of your product."),
        position: "top",
    }, ...stepUtils.mobileKanbanSearchMany2X('Product', 'm_1\{\+\|\?'), {
        ...
        mobile: false,
        trigger: ".o_data_row:has(.o_data_cell:contains('8n\+S\?\|\$\[')) .o_data_cell:first",
        content: _t('Select the generated request for quotation'),
        position: 'bottom',
    }, {
        mobile: true,
        trigger: ".o_kanban_record .o_kanban_record_title:contains('8n\+S\?\|\$\[')",
        content: _t('Select the generated request for quotation'),
        position: 'bottom',
