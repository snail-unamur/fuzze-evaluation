...
registry.category("web_tour.tours").add('fuzz_main_flow_tour_502', {
    test: true,
    url: "/web",
    steps: () => [...stepUtils.goToAppSteps('sale.sale_menu_root', markup(_t('Organize your sales activities with the <b>Sales app</b>.'))), stepUtils.openBurgerMenu(".o_breadcrumb .active:contains('Quotations')"), {
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('vw\}y\-\*\-\$')",
        auto: true,
    }, {
        mobile: true,
        trigger: ".o_selected_row .o_required_modifier[name=product_id] input",
        ...
        extra_trigger: ".o_breadcrumb .active:contains('vw\}y\-\*\-\$')",
        ...
        mobile: false,
        trigger: ".o-autocomplete--dropdown-item > a:contains('_p\*\|\*\?')",
        auto: true,
    }, {
        mobile: true,
        trigger: ".modal-footer .btn-primary:contains('Save')",
        ...
        mobile: false,
        trigger: ".o_data_cell:contains('pg\}\+\~\#')",
        ...
        mobile: false,
        edition: "enterprise",
        trigger: "div.o_bank_rec_st_line_kanban_card span:contains('pg\}\+\~\#')",
        extra_trigger: "div.o_bank_rec_st_line_kanban_card span:contains('pg\}\+\~\#')",
