...
registry.category("web_tour.tours").add('fuzz_main_flow_tour_25', {
    test: true,
    url: "/web",
    steps: () => [...stepUtils.goToAppSteps('sale.sale_menu_root', markup(_t('Organize your sales activities with the <b>Sales app</b>.'))), stepUtils.openBurgerMenu(".o_breadcrumb .active:contains('Quotations')"), {
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('72\{\#\.\[')",
        auto: true,
    }, {
        mobile: false,
        trigger: ".o_selected_row .o_external_button",
        ...
        content: _t("Select a vendor, or create a new one on the fly."),
        position: "bottom",
    }, ...stepUtils.mobileKanbanSearchMany2X('Vendor', 'ld\}\|\*\-'), {
        mobile: false,
        trigger: ".o_field_widget[name=seller_ids] .o_field_x2many_list_row_add > a",
        content: _t("Let's enter the cost price"),
        position: 'right',
        ...
        mobile: false,
        trigger: ".o_field_widget[name=partner_id] input",
        extra_trigger: ".o_breadcrumb .active:contains('72\{\#\.\[')",
        content: _t('Select a seller'),
        position: 'top',
        run: "text ld\}\|\*\-",
    }, {
        ...
        mobile: false,
        trigger: ".o-autocomplete--dropdown-item > a:contains('AZ\$\*\^\[')",
        auto: true,
    }, {
        mobile: true,
        trigger: ".modal-footer .btn-primary:contains('Save')",
        ...
        mobile: false,
        trigger: ".o_kanban_group:first .o_kanban_record span:contains('DV\~K_\^\~\{\#')",
        ...
        mobile: false,
        trigger: ".o_kanban_group:eq(2) > .o_kanban_record span:contains('DV\~K_\^\~\{\#')",
        content: _t("Click on an opportunity to zoom to it."),
        position: "bottom",
    }, {
        mobile: true,
        trigger: ".o_kanban_group:first .o_kanban_record span:contains('DV\~K_\^\~\{\#')",
        content: _t("Open DV\~K_\^\~\{\#"),
        position: "bottom",
    }, {
        mobile: true,
        ...
        content: _t("Write the name of your product."),
        position: "top",
    }, ...stepUtils.mobileKanbanSearchMany2X('Product', '72\{\#\.\['), {
        ...
        mobile: false,
        trigger: ".o_data_row:has(.o_data_cell:contains('ld\}\|\*\-')) .o_data_cell:first",
        ...
        content: "save",
        trigger: ".o_form_button_save",
    }, ...stepUtils.goBackBreadcrumbsMobile(_t('Back to the sale order'), undefined, ".o_breadcrumb .active:contains('W\#W\#\}\-\]')"), {
        mobile: false,
