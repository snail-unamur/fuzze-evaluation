...
registry.category("web_tour.tours").add('fuzz_main_flow_tour_230', {
    test: true,
    url: "/web",
    steps: () => [...stepUtils.goToAppSteps('sale.sale_menu_root', markup(_t('Organize your sales activities with the <b>Sales app</b>.'))), stepUtils.openBurgerMenu(".o_breadcrumb .active:contains('Quotations')"), {
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('JGtdY\?\?\?\$')",
        in_modal: false,
    }, {
        mobile: true,
        ...
        mobile: false,
        trigger: ".o_field_x2many_list_row_add > a",
        extra_trigger: ".o_breadcrumb .active:contains('z=x/\*\{\?\+')",
        content: _t("Click here to add some lines."),
        position: "bottom",
    }, {
        mobile: true,
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('VY9N\&\.\$\^')",
        auto: true,
    }, {
        mobile: false,
        trigger: ".o_selected_row .o_external_button",
        ...
        content: _t("Select a vendor, or create a new one on the fly."),
        position: "bottom",
    }, ...stepUtils.mobileKanbanSearchMany2X('Vendor', 'JGtdY\?\?\?\$'), {
        mobile: false,
        trigger: ".o_field_widget[name=seller_ids] .o_field_x2many_list_row_add > a",
        content: _t("Let's enter the cost price"),
        position: 'right',
        ...
        mobile: false,
        trigger: ".o_field_widget[name=partner_id] input",
        extra_trigger: ".o_breadcrumb .active:contains('VY9N\&\.\$\^')",
        content: _t('Select a seller'),
        position: 'top',
        run: "text JGtdY\?\?\?\$",
    }, {
        ...
        mobile: false,
        trigger: ".o_kanban_group:first .o_kanban_record span:contains('qN\-\&\{\&')",
        ...
        mobile: false,
        trigger: ".o_kanban_group:eq(2) > .o_kanban_record span:contains('qN\-\&\{\&')",
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('z=x/\*\{\?\+')",
    }, {
        mobile: false,
        trigger: "td[name='name'][data-tooltip*='z=x/\*\{\?\+']",
        run: () => {},
    }, {
        mobile: true,
        ...
        content: _t("Select a product, or create a new one on the fly. The product will define the default sales price (that you can change), taxes and description automatically."),
        position: "right",
    }, ...stepUtils.mobileKanbanSearchMany2X('Product', 'z=x/\*\{\?\+'), {
        mobile: false,
        trigger: ".o_field_widget[name=order_line] .o_field_x2many_list_row_add > a",
        content: _t("Click here to add some lines to your quotations."),
        position: "bottom",
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('6wYw\#\&\&\}')",
    }, {
        mobile: false,
        trigger: "td[name='name'][data-tooltip*='6wYw\#\&\&\}']",
        run: () => {},
    }, {
        mobile: false,
        ...
        mobile: true,
        trigger: ".o_field_widget[name=product_id] input",
        extra_trigger: ".o_field_widget[name=order_line] .oe_kanban_card:contains('z=x/\*\{\?\+')",
        content: _t("Select a product, or create a new one on the fly. The product will define the default sales price (that you can change), taxes and description automatically."),
        position: "right",
    }, ...stepUtils.mobileKanbanSearchMany2X('Product', '6wYw\#\&\&\}'), {
        mobile: true,
        trigger: ".modal-footer .btn-primary:contains('Save & Close')",
        extra_trigger: ".modal:not(.o_inactive_modal) .modal-title:contains('Order Lines')",
        content: _t('Save & Close'),
        ...
        content: _t("Write the name of your product."),
        position: "top",
    }, ...stepUtils.mobileKanbanSearchMany2X('Product', 'VY9N\&\.\$\^'), {
        ...
        mobile: false,
        trigger: ".o_data_row:has(.o_data_cell:contains('JGtdY\?\?\?\$')) .o_data_cell:first",
        content: _t('Select the generated request for quotation'),
        position: 'bottom',
    }, {
        mobile: true,
        trigger: ".o_kanban_record .o_kanban_record_title:contains('JGtdY\?\?\?\$')",
        content: _t('Select the generated request for quotation'),
        position: 'bottom',
        ...
        mobile: false,
        trigger: ".o_data_row:has(.o_data_cell:contains('z=x/\*\{\?\+')):first .o_data_cell:first",
        content: _t('Select the generated manufacturing order'),
        position: 'bottom',
    }, {
        mobile: true,
        trigger: ".o_kanban_record .o_kanban_record_title:contains('z=x/\*\{\?\+'):first",
        ...
        content: "save",
        trigger: ".o_form_button_save",
    }, ...stepUtils.goBackBreadcrumbsMobile(_t('Back to the sale order'), undefined, ".o_breadcrumb .active:contains('6wYw\#\&\&\}')"), {
        mobile: false,
