...
registry.category("web_tour.tours").add('fuzz_main_flow_tour_480', {
    test: true,
    url: "/web",
    steps: () => [...stepUtils.goToAppSteps('sale.sale_menu_root', markup(_t('Organize your sales activities with the <b>Sales app</b>.'))), stepUtils.openBurgerMenu(".o_breadcrumb .active:contains('Quotations')"), {
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('PNJc\?\+\}\$')",
        auto: true,
    }, {
        mobile: true,
        trigger: ".o_selected_row .o_required_modifier[name=product_id] input",
        ...
        extra_trigger: ".o_breadcrumb .active:contains('PNJc\?\+\}\$')",
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('j\[N\]\?\^\]')",
        auto: true,
    }, {
        mobile: false,
        trigger: ".o_selected_row .o_external_button",
        ...
        content: _t("Select a vendor, or create a new one on the fly."),
        position: "bottom",
    }, ...stepUtils.mobileKanbanSearchMany2X('Vendor', '8K\#\?\#\}'), {
        mobile: false,
        trigger: ".o_field_widget[name=seller_ids] .o_field_x2many_list_row_add > a",
        content: _t("Let's enter the cost price"),
        position: 'right',
        ...
        mobile: false,
        trigger: ".o_field_widget[name=partner_id] input",
        extra_trigger: ".o_breadcrumb .active:contains('j\[N\]\?\^\]')",
        content: _t('Select a seller'),
        position: 'top',
        run: "text 8K\#\?\#\}",
    }, {
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('EbT\#3\}\~\^\+')",
        auto: true,
    }, {
        mobile: true,
        trigger: ".modal-footer .btn-primary:contains('Save')",
        ...
        content: _t("Write the name of your product."),
        position: "top",
    }, ...stepUtils.mobileKanbanSearchMany2X('Product', 'j\[N\]\?\^\]'), {
        ...
        mobile: false,
        trigger: ".o_data_row:has(.o_data_cell:contains('8K\#\?\#\}')) .o_data_cell:first",
        ...
        mobile: false,
        edition: "enterprise",
        trigger: "div.o_bank_rec_st_line_kanban_card span:contains('EbT\#3\}\~\^\+')",
        extra_trigger: "div.o_bank_rec_st_line_kanban_card span:contains('EbT\#3\}\~\^\+')",
