...
registry.category("web_tour.tours").add('fuzz_main_flow_tour_529', {
    test: true,
    url: "/web",
    steps: () => [...stepUtils.goToAppSteps('sale.sale_menu_root', markup(_t('Organize your sales activities with the <b>Sales app</b>.'))), stepUtils.openBurgerMenu(".o_breadcrumb .active:contains('Quotations')"), {
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('A%G\*\~\~\|')",
        auto: true,
    }, {
        mobile: false,
        trigger: ".o_selected_row .o_external_button",
        ...
        mobile: false,
        trigger: ".o_field_widget[name=partner_id] input",
        extra_trigger: ".o_breadcrumb .active:contains('A%G\*\~\~\|')",
        content: _t('Select a seller'),
        position: 'top',
        run: "text \~O\{\~\}\*",
    }, {
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('ub61\*\]\^\}')",
        auto: true,
    }, {
        mobile: true,
        trigger: ".modal-footer .btn-primary:contains('Save')",
        ...
        content: _t("Write the name of your product."),
        position: "top",
    }, ...stepUtils.mobileKanbanSearchMany2X('Product', 'A%G\*\~\~\|'), {
        ...
        mobile: false,
        edition: "enterprise",
        trigger: "div.o_bank_rec_st_line_kanban_card span:contains('ub61\*\]\^\}')",
        extra_trigger: "div.o_bank_rec_st_line_kanban_card span:contains('ub61\*\]\^\}')",
