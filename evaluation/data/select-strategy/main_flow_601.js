...
registry.category("web_tour.tours").add('fuzz_main_flow_tour_601', {
    ...
    steps: () => [...stepUtils.goToAppSteps('sale.sale_menu_root', markup(_t('Organize your sales activities with the <b>Sales app</b>.'))), stepUtils.openBurgerMenu(".o_breadcrumb .active:contains('Quotations')"), {
        ...
        mobile: false,
        trigger: ".ui-menu-item > a:contains('5\}Y\-\|\^\~')",
        auto: true,
    }, {
        mobile: false,
        trigger: ".o_selected_row .o_external_button",
        ...
        mobile: false,
        trigger: ".o_field_widget[name=partner_id] input",
        extra_trigger: ".o_breadcrumb .active:contains('5\}Y\-\|\^\~')",
        content: _t('Select a seller'),
        position: 'top',
        run: "text >`@n\[\[\|\#",
    }, {
        ...
        content: _t("Write the name of your product."),
        position: "top",
    }, ...stepUtils.mobileKanbanSearchMany2X('Product', '5\}Y\-\|\^\~'), {
        ...
        mobile: false,
        edition: "enterprise",
        trigger: "div.o_bank_rec_st_line_kanban_card span:contains('TY\$\$\#\#')",
        extra_trigger: "div.o_bank_rec_st_line_kanban_card span:contains('TY\$\$\#\#')",
