// Generated from f:/Github/Fuzzee/fuzze/tours/parsing/grammar/JavaScriptParser.g4 by ANTLR 4.13.1
...
public class JavaScriptParser extends JavaScriptParserBase {
	...
	public final ExpressionStatementContext expressionStatement() throws RecognitionException {
		...
		try {
			...
			{
			setState(354);
			if (!(self.notOpenBraceAndNotFunction())) throw new FailedPredicateException(this, "self.notOpenBraceAndNotFunction()");
			setState(355);
			expressionSequence();
			setState(356);
			eos();
	...
	public final ContinueStatementContext continueStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(430);
				if (!(self.notLineTerminator())) throw new FailedPredicateException(this, "self.notLineTerminator()");
				setState(431);
				identifier();
				}
				break;
		...
		try {
			...
			case 1:
				...
				case 2:
					{
					setState(564);
					if (!(self.n("static"))) throw new FailedPredicateException(this, "self.n(\"static\")");
					setState(565);
					identifier();
					}
					break;
	...
	public final GetterContext getter() throws RecognitionException {
		...
		try {
			...
			{
			setState(1020);
			if (!(self.n("get"))) throw new FailedPredicateException(this, "self.n(\"get\")");
			setState(1021);
			identifier();
			setState(1022);
			classElementName();
	...
	public final SetterContext setter() throws RecognitionException {
		...
		try {
			...
			{
			setState(1024);
			if (!(self.n("set"))) throw new FailedPredicateException(this, "self.n(\"set\")");
			setState(1025);
			identifier();
			setState(1026);
			classElementName();
	...
	public final EosContext eos() throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				{
				setState(1094);
				if (!(self.closeBrace())) throw new FailedPredicateException(this, "self.closeBrace()");
				}
				break;
			}
		}
