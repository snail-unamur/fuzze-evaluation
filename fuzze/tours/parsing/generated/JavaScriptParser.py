...
class JavaScriptParser(JavaScriptParserBase):
    ...
    def importFromBlock(self):
        ...
        try:
            ...
            if token in [
                ...
                JavaScriptParser.Multiply,
                JavaScriptParser.NullLiteral,
                JavaScriptParser.BooleanLiteral,
                JavaScriptParser.Break,
                JavaScriptParser.Do,
                JavaScriptParser.Instanceof,
                JavaScriptParser.Typeof,
                JavaScriptParser.Case,
                JavaScriptParser.Else,
                JavaScriptParser.New,
                JavaScriptParser.Var,
                JavaScriptParser.Catch,
                JavaScriptParser.Finally,
                JavaScriptParser.Return,
                JavaScriptParser.Void,
                JavaScriptParser.Continue,
                JavaScriptParser.For,
                JavaScriptParser.Switch,
                JavaScriptParser.While,
                JavaScriptParser.Debugger,
                JavaScriptParser.Function_,
                JavaScriptParser.This,
                JavaScriptParser.With,
                JavaScriptParser.Default,
                JavaScriptParser.If,
                JavaScriptParser.Throw,
                JavaScriptParser.Delete,
                JavaScriptParser.In,
                JavaScriptParser.Try,
                JavaScriptParser.As,
                JavaScriptParser.From,
                JavaScriptParser.Of,
                JavaScriptParser.Yield,
                JavaScriptParser.YieldStar,
                JavaScriptParser.Class,
                JavaScriptParser.Enum,
                JavaScriptParser.Extends,
                JavaScriptParser.Super,
                JavaScriptParser.Const,
                JavaScriptParser.Export,
                JavaScriptParser.Import,
                JavaScriptParser.Async,
                JavaScriptParser.Await,
                JavaScriptParser.Implements,
                JavaScriptParser.StrictLet,
                JavaScriptParser.NonStrictLet,
                JavaScriptParser.Private,
                JavaScriptParser.Public,
                JavaScriptParser.Interface,
                JavaScriptParser.Package,
                JavaScriptParser.Protected,
                JavaScriptParser.Static,
    ...
    def importModuleItems(self):
        ...
        try:
            ...
            if (((_la - 62)) & ~0x3F) == 0 and (
                (1 << (_la - 62))
                & (
                    (1 << (JavaScriptParser.NullLiteral - 62))
                    | (1 << (JavaScriptParser.BooleanLiteral - 62))
                    | (1 << (JavaScriptParser.Break - 62))
                    | (1 << (JavaScriptParser.Do - 62))
                    | (1 << (JavaScriptParser.Instanceof - 62))
                    | (1 << (JavaScriptParser.Typeof - 62))
                    | (1 << (JavaScriptParser.Case - 62))
                    | (1 << (JavaScriptParser.Else - 62))
                    | (1 << (JavaScriptParser.New - 62))
                    | (1 << (JavaScriptParser.Var - 62))
                    | (1 << (JavaScriptParser.Catch - 62))
                    | (1 << (JavaScriptParser.Finally - 62))
                    | (1 << (JavaScriptParser.Return - 62))
                    | (1 << (JavaScriptParser.Void - 62))
                    | (1 << (JavaScriptParser.Continue - 62))
                    | (1 << (JavaScriptParser.For - 62))
                    | (1 << (JavaScriptParser.Switch - 62))
                    | (1 << (JavaScriptParser.While - 62))
                    | (1 << (JavaScriptParser.Debugger - 62))
                    | (1 << (JavaScriptParser.Function_ - 62))
                    | (1 << (JavaScriptParser.This - 62))
                    | (1 << (JavaScriptParser.With - 62))
                    | (1 << (JavaScriptParser.Default - 62))
                    | (1 << (JavaScriptParser.If - 62))
                    | (1 << (JavaScriptParser.Throw - 62))
                    | (1 << (JavaScriptParser.Delete - 62))
                    | (1 << (JavaScriptParser.In - 62))
                    | (1 << (JavaScriptParser.Try - 62))
                    | (1 << (JavaScriptParser.As - 62))
                    | (1 << (JavaScriptParser.From - 62))
                    | (1 << (JavaScriptParser.Of - 62))
                    | (1 << (JavaScriptParser.Yield - 62))
                    | (1 << (JavaScriptParser.YieldStar - 62))
                    | (1 << (JavaScriptParser.Class - 62))
                    | (1 << (JavaScriptParser.Enum - 62))
                    | (1 << (JavaScriptParser.Extends - 62))
                    | (1 << (JavaScriptParser.Super - 62))
                    | (1 << (JavaScriptParser.Const - 62))
                    | (1 << (JavaScriptParser.Export - 62))
                    | (1 << (JavaScriptParser.Import - 62))
                    | (1 << (JavaScriptParser.Async - 62))
                    | (1 << (JavaScriptParser.Await - 62))
                    | (1 << (JavaScriptParser.Implements - 62))
                    | (1 << (JavaScriptParser.StrictLet - 62))
                    | (1 << (JavaScriptParser.NonStrictLet - 62))
                    | (1 << (JavaScriptParser.Private - 62))
                    | (1 << (JavaScriptParser.Public - 62))
                    | (1 << (JavaScriptParser.Interface - 62))
                    | (1 << (JavaScriptParser.Package - 62))
                    | (1 << (JavaScriptParser.Protected - 62))
                    | (1 << (JavaScriptParser.Static - 62))
                    | (1 << (JavaScriptParser.Identifier - 62))
                    | (1 << (JavaScriptParser.StringLiteral - 62))
                )
            ) != 0:
                self.state = 241
                self.importAliasName()
            ...
            if not (
                (
                    ...
                    and (
                        (1 << (_la - 102))
                        & (
                            (1 << (JavaScriptParser.Yield - 102))
                            | (1 << (JavaScriptParser.Await - 102))
                            | (1 << (JavaScriptParser.Identifier - 102))
                        )
                    )
                    != 0
                )
            ...
            if la_ == 1:
                ...
                if (
                    ...
                    and (
                        (1 << _la)
                        & (
                            (1 << JavaScriptParser.RegularExpressionLiteral)
                            | (1 << JavaScriptParser.OpenBracket)
                            | (1 << JavaScriptParser.OpenParen)
                            | (1 << JavaScriptParser.OpenBrace)
                            | (1 << JavaScriptParser.PlusPlus)
                            | (1 << JavaScriptParser.MinusMinus)
                            | (1 << JavaScriptParser.Plus)
                            | (1 << JavaScriptParser.Minus)
                            | (1 << JavaScriptParser.BitNot)
                            | (1 << JavaScriptParser.Not)
                            | (1 << JavaScriptParser.NullLiteral)
                            | (1 << JavaScriptParser.BooleanLiteral)
                        )
                    )
                    != 0
                ) or (
                    ...
                    and (
                        (1 << (_la - 64))
                        & (
                            (1 << (JavaScriptParser.DecimalLiteral - 64))
                            | (1 << (JavaScriptParser.HexIntegerLiteral - 64))
                            | (1 << (JavaScriptParser.OctalIntegerLiteral - 64))
                            | (1 << (JavaScriptParser.OctalIntegerLiteral2 - 64))
                            ...
                            | (1 << (JavaScriptParser.Break - 64))
                            | (1 << (JavaScriptParser.Do - 64))
                            | (1 << (JavaScriptParser.Instanceof - 64))
                            | (1 << (JavaScriptParser.Typeof - 64))
                            | (1 << (JavaScriptParser.Case - 64))
                            | (1 << (JavaScriptParser.Else - 64))
                            | (1 << (JavaScriptParser.New - 64))
                            | (1 << (JavaScriptParser.Var - 64))
                            | (1 << (JavaScriptParser.Catch - 64))
                            | (1 << (JavaScriptParser.Finally - 64))
                            | (1 << (JavaScriptParser.Return - 64))
                            | (1 << (JavaScriptParser.Void - 64))
                            | (1 << (JavaScriptParser.Continue - 64))
                            | (1 << (JavaScriptParser.For - 64))
                            | (1 << (JavaScriptParser.Switch - 64))
                            | (1 << (JavaScriptParser.While - 64))
                            | (1 << (JavaScriptParser.Debugger - 64))
                            | (1 << (JavaScriptParser.Function_ - 64))
                            | (1 << (JavaScriptParser.This - 64))
                            | (1 << (JavaScriptParser.With - 64))
                            | (1 << (JavaScriptParser.Default - 64))
                            | (1 << (JavaScriptParser.If - 64))
                            | (1 << (JavaScriptParser.Throw - 64))
                            | (1 << (JavaScriptParser.Delete - 64))
                            | (1 << (JavaScriptParser.In - 64))
                            | (1 << (JavaScriptParser.Try - 64))
                            | (1 << (JavaScriptParser.As - 64))
                            | (1 << (JavaScriptParser.From - 64))
                            | (1 << (JavaScriptParser.Of - 64))
                            | (1 << (JavaScriptParser.Yield - 64))
                            | (1 << (JavaScriptParser.YieldStar - 64))
                            | (1 << (JavaScriptParser.Class - 64))
                            | (1 << (JavaScriptParser.Enum - 64))
                            | (1 << (JavaScriptParser.Extends - 64))
                            | (1 << (JavaScriptParser.Super - 64))
                            | (1 << (JavaScriptParser.Const - 64))
                            | (1 << (JavaScriptParser.Export - 64))
                            | (1 << (JavaScriptParser.Import - 64))
                            | (1 << (JavaScriptParser.Async - 64))
                            | (1 << (JavaScriptParser.Await - 64))
                            | (1 << (JavaScriptParser.Implements - 64))
                            | (1 << (JavaScriptParser.StrictLet - 64))
                            | (1 << (JavaScriptParser.NonStrictLet - 64))
                            | (1 << (JavaScriptParser.Private - 64))
                            | (1 << (JavaScriptParser.Public - 64))
                            | (1 << (JavaScriptParser.Interface - 64))
                            | (1 << (JavaScriptParser.Package - 64))
                            | (1 << (JavaScriptParser.Protected - 64))
                            | (1 << (JavaScriptParser.Static - 64))
                            | (1 << (JavaScriptParser.Identifier - 64))
                            | (1 << (JavaScriptParser.StringLiteral - 64))
                            | (1 << (JavaScriptParser.BackTick - 64))
                        )
                    )
                    != 0
                ):
    ...
    def yieldStatement(self):
        ...
        try:
            ...
            self.state = 450
            _la = self._input.LA(1)
            if not (_la == JavaScriptParser.Yield or _la == JavaScriptParser.YieldStar):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    def catchProduction(self):
        ...
        try:
            ...
            if _la == JavaScriptParser.OpenParen:
                ...
                _la = self._input.LA(1)
                if (
                    _la == JavaScriptParser.OpenBracket
                    or _la == JavaScriptParser.OpenBrace
                    or (
                        (((_la - 73)) & ~0x3F) == 0
                        and (
                            (1 << (_la - 73))
                            & (
                                (1 << (JavaScriptParser.Break - 73))
                                | (1 << (JavaScriptParser.Do - 73))
                                | (1 << (JavaScriptParser.Instanceof - 73))
                                | (1 << (JavaScriptParser.Typeof - 73))
                                | (1 << (JavaScriptParser.Case - 73))
                                | (1 << (JavaScriptParser.Else - 73))
                                | (1 << (JavaScriptParser.New - 73))
                                | (1 << (JavaScriptParser.Var - 73))
                                | (1 << (JavaScriptParser.Catch - 73))
                                | (1 << (JavaScriptParser.Finally - 73))
                                | (1 << (JavaScriptParser.Return - 73))
                                | (1 << (JavaScriptParser.Void - 73))
                                | (1 << (JavaScriptParser.Continue - 73))
                                | (1 << (JavaScriptParser.For - 73))
                                | (1 << (JavaScriptParser.Switch - 73))
                                | (1 << (JavaScriptParser.While - 73))
                                | (1 << (JavaScriptParser.Debugger - 73))
                                | (1 << (JavaScriptParser.Function_ - 73))
                                | (1 << (JavaScriptParser.This - 73))
                                | (1 << (JavaScriptParser.With - 73))
                                | (1 << (JavaScriptParser.Default - 73))
                                | (1 << (JavaScriptParser.If - 73))
                                | (1 << (JavaScriptParser.Throw - 73))
                                | (1 << (JavaScriptParser.Delete - 73))
                                | (1 << (JavaScriptParser.In - 73))
                                | (1 << (JavaScriptParser.Try - 73))
                                | (1 << (JavaScriptParser.As - 73))
                                | (1 << (JavaScriptParser.From - 73))
                                | (1 << (JavaScriptParser.Of - 73))
                                | (1 << (JavaScriptParser.Yield - 73))
                                | (1 << (JavaScriptParser.YieldStar - 73))
                                | (1 << (JavaScriptParser.Class - 73))
                                | (1 << (JavaScriptParser.Enum - 73))
                                | (1 << (JavaScriptParser.Extends - 73))
                                | (1 << (JavaScriptParser.Super - 73))
                                | (1 << (JavaScriptParser.Const - 73))
                                | (1 << (JavaScriptParser.Export - 73))
                                | (1 << (JavaScriptParser.Import - 73))
                                | (1 << (JavaScriptParser.Async - 73))
                                | (1 << (JavaScriptParser.Await - 73))
                                | (1 << (JavaScriptParser.Implements - 73))
                                | (1 << (JavaScriptParser.StrictLet - 73))
                                | (1 << (JavaScriptParser.NonStrictLet - 73))
                                | (1 << (JavaScriptParser.Private - 73))
                                | (1 << (JavaScriptParser.Public - 73))
                                | (1 << (JavaScriptParser.Interface - 73))
                                | (1 << (JavaScriptParser.Package - 73))
                                | (1 << (JavaScriptParser.Protected - 73))
                                | (1 << (JavaScriptParser.Static - 73))
                                | (1 << (JavaScriptParser.Identifier - 73))
                            )
                        )
                        != 0
                    )
    ...
    def classElementName(self):
        ...
        try:
            ...
            token = self._input.LA(1)
            if token in [
                JavaScriptParser.OpenBracket,
                JavaScriptParser.NullLiteral,
                JavaScriptParser.BooleanLiteral,
                JavaScriptParser.DecimalLiteral,
                JavaScriptParser.HexIntegerLiteral,
                JavaScriptParser.OctalIntegerLiteral,
                JavaScriptParser.OctalIntegerLiteral2,
                ...
                JavaScriptParser.Static,
                JavaScriptParser.Identifier,
                JavaScriptParser.StringLiteral,
            ]:
                self.enterOuterAlt(localctx, 1)
                self.state = 624
                self.propertyName()
                pass
            elif token in [JavaScriptParser.Hashtag]:
                self.enterOuterAlt(localctx, 2)
                self.state = 625
    ...
    def singleExpression(self, _p: int = 0):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la - 99)) & ~0x3F) == 0 and (
                    (1 << (_la - 99))
                    & (
                        (1 << (JavaScriptParser.As - 99))
                        | (1 << (JavaScriptParser.From - 99))
                        | (1 << (JavaScriptParser.Of - 99))
                        | (1 << (JavaScriptParser.Yield - 99))
                        | (1 << (JavaScriptParser.Async - 99))
                        | (1 << (JavaScriptParser.NonStrictLet - 99))
                        | (1 << (JavaScriptParser.Identifier - 99))
                    )
                ) != 0:
                    self.state = 784
                    self.identifier()
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    if la_ == 1:
                        ...
                        if not (
                            (
                                ...
                                and (
                                    (1 << _la)
                                    & (
                                        (1 << JavaScriptParser.Multiply)
                                        | (1 << JavaScriptParser.Divide)
                                        | (1 << JavaScriptParser.Modulus)
                                    )
                                )
                                != 0
                            )
                        ...
                        _la = self._input.LA(1)
                        if not (
                            _la == JavaScriptParser.Plus
                            or _la == JavaScriptParser.Minus
                        ):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                            ...
                            (
                                ...
                                and (
                                    ...
                                    & (
                                        ...
                                        | (1 << JavaScriptParser.RightShiftLogical)
                                    )
                                )
                                != 0
                            )
                        ...
                        if not (
                            (
                                ...
                                and (
                                    (1 << _la)
                                    & (
                                        (1 << JavaScriptParser.LessThan)
                                        | (1 << JavaScriptParser.MoreThan)
                                        | (1 << JavaScriptParser.LessThanEquals)
                                        | (1 << JavaScriptParser.GreaterThanEquals)
                                    )
                                )
                                != 0
                            )
                        ...
                        if not (
                            (
                                ...
                                and (
                                    (1 << _la)
                                    & (
                                        (1 << JavaScriptParser.Equals_)
                                        | (1 << JavaScriptParser.NotEquals)
                                        | (1 << JavaScriptParser.IdentityEquals)
                                        | (1 << JavaScriptParser.IdentityNotEquals)
                                    )
                                )
                                != 0
                            )
            ...
            if not (
                (
                    ...
                    and (
                        (1 << _la)
                        & (
                            (1 << JavaScriptParser.MultiplyAssign)
                            | (1 << JavaScriptParser.DivideAssign)
                            | (1 << JavaScriptParser.ModulusAssign)
                            | (1 << JavaScriptParser.PlusAssign)
                            | (1 << JavaScriptParser.MinusAssign)
                            | (1 << JavaScriptParser.LeftShiftArithmeticAssign)
                            | (1 << JavaScriptParser.RightShiftArithmeticAssign)
                            | (1 << JavaScriptParser.RightShiftLogicalAssign)
                            | (1 << JavaScriptParser.BitAndAssign)
                            | (1 << JavaScriptParser.BitXorAssign)
                            | (1 << JavaScriptParser.BitOrAssign)
                            | (1 << JavaScriptParser.PowerAssign)
                            | (1 << JavaScriptParser.NullishCoalescingAssign)
                        )
                    )
                    != 0
                )
    ...
    def literal(self):
        ...
        try:
            ...
            if token in [JavaScriptParser.NullLiteral]:
                ...
                JavaScriptParser.BigHexIntegerLiteral,
                JavaScriptParser.BigOctalIntegerLiteral,
                JavaScriptParser.BigBinaryIntegerLiteral,
                JavaScriptParser.BigDecimalIntegerLiteral,
            ]:
                self.enterOuterAlt(localctx, 7)
                self.state = 997
                self.bigintLiteral()
    ...
    def templateStringLiteral(self):
        ...
        try:
            ...
            while (
                ...
                or _la == JavaScriptParser.TemplateStringAtom
            ):
                self.state = 1001
            ...
            if not (
                (
                    ...
                    and (
                        (1 << (_la - 69))
                        & (
                            (1 << (JavaScriptParser.BigHexIntegerLiteral - 69))
                            | (1 << (JavaScriptParser.BigOctalIntegerLiteral - 69))
                            | (1 << (JavaScriptParser.BigBinaryIntegerLiteral - 69))
                            | (1 << (JavaScriptParser.BigDecimalIntegerLiteral - 69))
                        )
                    )
                    != 0
                )
    ...
    def keyword(self):
        ...
        try:
            ...
            if token in [JavaScriptParser.Break]:
                ...
                pass
            elif token in [JavaScriptParser.YieldStar]:
                ...
                self.match(JavaScriptParser.As)
                pass
            elif token in [JavaScriptParser.Of]:
    ...
    def let_(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            if not (
                _la == JavaScriptParser.StrictLet
                or _la == JavaScriptParser.NonStrictLet
            ):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
